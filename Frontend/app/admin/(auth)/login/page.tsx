...
// 1. We move the form logic into a sub-component to use useSearchParams
function LoginForm() {
...
// 2. The main Page component wraps the sub-component in Suspense
  ...
  return (
    <main style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', padding: 24 }}>
      <div style={{ width: '100%', maxWidth: 440, border: '1px solid rgba(0,0,0,.08)', borderRadius: 16, padding: 24 }}>
        ...
        <Suspense fallback={<p style={{ fontSize: 13, opacity: 0.5 }}>Loading form...</p>}>
          <LoginForm />
        </Suspense>
      </div>
    </main>
